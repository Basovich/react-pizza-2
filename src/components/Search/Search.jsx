...
export function Search() {
  ...
  const handleOnClearSearch = useCallback( event => {
  ...
  return (
    <StyledSearch>
      ...
      <input className="search"
             onChange={(event) => dispatch(changeSearch(event.target.value.trim()))}
             type="text"
      ...
      {
        searchValue && (
          <button className="clear" onClick={handleOnClearSearch} type="button">
