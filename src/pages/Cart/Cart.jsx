...
import {StyledClearCartButton, StyledCartHead, StyledCartHeadTitle, StyledCart} from "./StyledCart";
  ...
  return (
    <>
      ...
      <StyledCart>
        <StyledCartHead>
          <StyledCartHeadTitle>
            <svg className="title-icon" width="31" height="31" viewBox="0 0 31 31" fill="none"
          ...
          <StyledClearCartButton type="button">
            <svg className="basket-icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
